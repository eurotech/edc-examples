...
public class ModbusManager implements ConfigurableComponent, CriticalComponent, CloudClientListener{
	...
	protected void deactivate(ComponentContext componentContext) {
		...
		if(m_watchdogService!=null)		
			m_watchdogService.unregisterCriticalComponent(this); 
	...
	private void TurnOnLED(int LED, boolean On)throws ModbusProtocolException
	{
		...
		{
			switch(LED) {
			case 1:		s_logger.info("Setting LED" + LED + " to " + On);
						break;
			case 2:		s_logger.info("Setting LED" + LED + " to " + On);
						break;
			case 3:		s_logger.info("Setting LED" + LED + " to " + On);
						break;
			case 4:		s_logger.info("Setting LED4 red to " + On);
						break;
			case 5:		s_logger.info("Setting LED4 green to " + On);
						break;
			case 6:		s_logger.info("Setting LED4 blue to " + On);
						break;
	...
	private void ProcessBytePayload(String assetId, String topic, byte[] payload, int qos, boolean retain) {
